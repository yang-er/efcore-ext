...
{
    public class MySqlBulkQueryCompiler : BulkQueryCompiler
    {
        public MySqlBulkQueryCompiler(
        ...
        protected override Func<QueryContext, TResult> CompileBulkCore<TResult>(IDatabase database, Expression query, IModel model, bool async)
        {
            ...
            {
                throw TranslationFailed(query, "MERGE INTO sentences are not supported in MySQL.");
            }
