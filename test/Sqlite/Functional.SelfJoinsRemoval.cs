...
{
    public class SqliteUselessJoinsRemovalTest : UselessJoinsRemovalTestBase<SqliteContextFactory<TestingContext>>
    {
        public SqliteUselessJoinsRemovalTest(
            SqliteContextFactory<TestingContext> factory)
            : base(factory)
        {
        }
